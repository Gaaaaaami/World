...
public:
    ...
    bool GenerateMesh(const UNoiseGenerator* NoiseGenerator, UObject *thiz = nullptr, TObjectPtr<URHIDensityTools> InRHIDT = nullptr);
    bool RHIGenerateMesh(TArray<float> InDensityField, UObject* thiz = nullptr);
